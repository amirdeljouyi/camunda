...
val openApiGenerateExporter by
  tasks.registering(org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    generatorName.set("spring")
...
val syncOpenApiGeneratedSources by
