...
import io.camunda.client.protocol.rest.ElementInstanceKeyFilterProperty;
import io.camunda.client.protocol.rest.JobKeyFilterProperty;
...
public class AgentInstanceHistoryFilterImpl
  ...
  public AgentInstanceHistoryFilter elementInstanceKey(final Consumer<BasicLongProperty> fn) {
    final BasicLongPropertyImpl property = new BasicLongPropertyImpl();
    fn.accept(property);
    filter.setElementInstanceKey(
        toElementInstanceKeyFilterProperty(provideSearchRequestProperty(property)));
    return this;
  }
  ...
  public AgentInstanceHistoryFilter jobKey(final Consumer<BasicLongProperty> fn) {
    final BasicLongPropertyImpl property = new BasicLongPropertyImpl();
    fn.accept(property);
    filter.setJobKey(toJobKeyFilterProperty(provideSearchRequestProperty(property)));
    return this;
  }
  ...
  private ElementInstanceKeyFilterProperty toElementInstanceKeyFilterProperty(
      final BasicStringFilterProperty src) {
    final ElementInstanceKeyFilterProperty dest = new ElementInstanceKeyFilterProperty();
    dest.set$Eq(src.get$Eq());
    dest.set$Neq(src.get$Neq());
    dest.set$Exists(src.get$Exists());
    dest.set$In(src.get$In());
  ...
  private JobKeyFilterProperty toJobKeyFilterProperty(final BasicStringFilterProperty src) {
    final JobKeyFilterProperty dest = new JobKeyFilterProperty();
    dest.set$Eq(src.get$Eq());
    dest.set$Neq(src.get$Neq());
    dest.set$Exists(src.get$Exists());
    dest.set$In(src.get$In());
