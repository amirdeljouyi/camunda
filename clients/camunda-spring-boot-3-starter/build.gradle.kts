...
val generateJobWorkerPermutations by
...
tasks.named<com.github.jengelman.gradle.plugins.shadow.tasks.ShadowJar>("shadowJar") {
  ...
  dependencies { include(project(":camunda-spring-boot-starter")) }
...
tasks.named<Test>("test") {
  dependsOn(baseStarter.tasks.named("compileJava"), baseStarter.tasks.named("processResources"))
  classpath =
    files(
