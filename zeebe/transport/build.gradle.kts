...
// Copy stream-protocol.xml to classes directory (like Maven does) so XInclude paths resolve
// correctly
...
tasks.named<JavaExec>("generateSbe") {
  ...
  args(
    layout.buildDirectory.file("classes/java/main/stream-protocol.xml").get().asFile.absolutePath
  )
